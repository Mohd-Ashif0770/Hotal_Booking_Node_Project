...
const sampleListings = [
  ...
  },
  {
    ...
    description:
      "Charming A-frame cabin nestled in a quiet forest. Ideal for writers and artists.",
    image: {
      filename: "sample",
  ...
  },
  {
    ...
    description:
      "Step outside to the beach. A tranquil bungalow with stunning ocean views.",
    image: {
      filename: "sample",
  ...
  {
    title: "Himalayan Wooden Stay",
    description:
      "Traditional wooden house with breathtaking Himalayan views. Peaceful and serene.",
    image: {
      filename: "sample",
